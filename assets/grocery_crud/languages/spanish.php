...
/* Translated by Hector Cyc */
	...
	$lang['set_relation_title']		= 'Elija {field_display_as}';
	...
	$lang['error_on_uploading'] 	= "Se produjo un error en la carga.";
	$lang['message_promt_delete_file'] 	= "¿Está seguro que desea eliminar este archivo?";

	$lang['error_max_number_of_files'] 	= "Sólo puedes subir un archivo a la vez.";
	$lang['error_accept_file_types'] 	= "No tiene permisos para subir este tipo de extensión.";
	$lang['error_max_file_size'] 		= "El archivo subido excede la directiva {max_file_size} que se ha especificado.";
	$lang['error_min_file_size'] 		= "No puedes subir un archivo vacío.";